...
#returns: a distilled/melted version of dataset sorted by library plate number and treatments (untreated is NOT duplicated).
#perfect for plotting facets using ggplots
